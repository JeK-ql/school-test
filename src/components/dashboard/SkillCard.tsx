    ...
    <div className="group relative">
      {p.description && (
        ...
        >
          ...
          <p className="font-mono text-[11px] leading-relaxed text-text">{p.description}</p>
          <span
            aria-hidden
      ...
      <NeonCard
        variant="bracketed"
        className="hud-panel relative animate-scan-in"
      ...
      >
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex justify-between font-mono text-[10px] mt-1.5 tabular-nums">
              ...
              <span className="text-text-muted">
                {p.lastRunAt ? `ACC ${Math.round(p.lastRunAccuracy * 100)}%` : 'NO RUNS'}
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-5">
          <NeonButton className="w-full" onClick={onEnter}>
            ◢&nbsp;&nbsp;ENTER DUNGEON
          </NeonButton>
        </div>
      </NeonCard>
